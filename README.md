...
### Самое главное — точно понять и определить цели и задачи сбора и организации знаний. В противном случае можно потратить много времени на работу "в стол". 
